 ...
 */
public class FastLzFrameEncoder extends CompressionHandler {

    private static final class FastLzCompressor implements Compressor {
        /**
         * Compression level.
         */
         ...
         */
        FastLzCompressor(boolean validateChecksums) {
         ...
         */
        FastLzCompressor(int level, Checksum checksum) {
    ...
    public FastLzFrameEncoder(int level, Checksum checksum) {
        super(() -> new FastLzCompressor(level, checksum));
    }
}
