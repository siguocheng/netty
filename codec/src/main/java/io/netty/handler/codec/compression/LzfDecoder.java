 ...
 */
public class LzfDecoder extends DecompressionHandler {

    private static final class LzfDecompressor implements Decompressor {
        /**
         ...
         */
        LzfDecompressor(boolean safeInstance) {
    ...
    public LzfDecoder(boolean safeInstance) {
        super(() -> new LzfDecompressor(safeInstance));
    }
}
