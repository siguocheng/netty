 ...
 * set to {@code true}.
 */
public class SnappyFrameDecoder extends DecompressionHandler {

    private static final class SnappyDecompressor implements Decompressor {
         ...
         */
        SnappyDecompressor(boolean validateChecksums) {
    ...
    public SnappyFrameDecoder(boolean validateChecksums) {
        super(() -> new SnappyDecompressor(validateChecksums));
    }
}
