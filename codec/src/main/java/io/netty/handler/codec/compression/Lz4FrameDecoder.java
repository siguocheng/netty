 ...
 *  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *     * * * * * * * * * *
 */
public class Lz4FrameDecoder extends DecompressionHandler {

    private static final class Lz4Decompressor implements Decompressor {
        /**
         ...
         */
        Lz4Decompressor(boolean validateChecksums) {
         ...
         *                           which may be JNI bindings to the original C implementation, a pure Java
         *                           implementation or a Java implementation that uses the {@link sun.misc.Unsafe}
         * @param validateChecksums  if {@code true}, the checksum field will be validated against the actual
         *                           uncompressed data, and if the checksums do not match, a suitable
         ...
         */
        Lz4Decompressor(LZ4Factory factory, boolean validateChecksums) {
         ...
         */
        Lz4Decompressor(LZ4Factory factory, Checksum checksum) {
    ...
    public Lz4FrameDecoder(LZ4Factory factory, Checksum checksum) {
        super(() -> new Lz4Decompressor(factory, checksum));
    }
}
