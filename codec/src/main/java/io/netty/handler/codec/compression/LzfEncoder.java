 ...
 */
public class LzfEncoder extends CompressionHandler {

    private static final class LzfCompressor implements Compressor {
         ...
         */
        LzfCompressor(boolean safeInstance) {
         ...
         */
        LzfCompressor(boolean safeInstance, int totalLength) {
         ...
         *                              to the LZF format.
         */
        LzfCompressor(boolean safeInstance, int totalLength, int compressThreshold) {
    ...
    public LzfEncoder(boolean safeInstance, int totalLength) {
        this(safeInstance, totalLength, LzfCompressor.MIN_BLOCK_TO_COMPRESS);
    }
    ...
    public LzfEncoder(boolean safeInstance, int totalLength, int compressThreshold) {
       super(() -> new LzfCompressor(safeInstance, totalLength, compressThreshold));
    }
}
