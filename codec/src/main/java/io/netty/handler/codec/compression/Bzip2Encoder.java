 ...
 */
public class Bzip2Encoder extends CompressionHandler {

    private static final class Bzip2Compressor implements Compressor {
        /**
         ...
         */
        Bzip2Compressor(final int blockSizeMultiplier) {
    ...
    public Bzip2Encoder(final int blockSizeMultiplier) {
        super(() -> new Bzip2Compressor(blockSizeMultiplier));
    }
}
