 ...
 */
public class LzmaFrameEncoder extends CompressionHandler {

    private static final class LzmaCompressor implements Compressor {
         ...
         */
        LzmaCompressor(int lc, int lp, int pb) {
         ...
         */
        LzmaCompressor(int dictionarySize) {
         ...
         */
        LzmaCompressor(int lc, int lp, int pb, int dictionarySize) {
         ...
         */
        LzmaCompressor(int lc, int lp, int pb, int dictionarySize, boolean endMarkerMode, int numFastBytes) {
            if (lc < 0 || lc > 8) {
    ...
    public LzmaFrameEncoder() {
        this(LzmaCompressor.MEDIUM_DICTIONARY_SIZE);
    }
    ...
    public LzmaFrameEncoder(int lc, int lp, int pb) {
        this(lc, lp, pb, LzmaCompressor.MEDIUM_DICTIONARY_SIZE);
    }
    ...
    public LzmaFrameEncoder(int dictionarySize) {
        this(LzmaCompressor.DEFAULT_LC, LzmaCompressor.DEFAULT_LP, LzmaCompressor.DEFAULT_PB, dictionarySize);
    }
    ...
    public LzmaFrameEncoder(int lc, int lp, int pb, int dictionarySize) {
        this(lc, lp, pb, dictionarySize, false, LzmaCompressor.MEDIUM_FAST_BYTES);
    }
    ...
    public LzmaFrameEncoder(int lc, int lp, int pb, int dictionarySize, boolean endMarkerMode, int numFastBytes) {
        super(() -> new LzmaCompressor(lc, lp, pb, dictionarySize, endMarkerMode, numFastBytes));
    }
}
