 ...
 */
public class JdkZlibDecoder extends DecompressionHandler {
    private static final class JdkZlibDecompressor implements Decompressor {
         ...
         */
        JdkZlibDecompressor(int maxAllocation) {
         ...
         */
        JdkZlibDecompressor(byte[] dictionary) {
         ...
         *          If zero, maximum size is decided by the {@link ByteBufAllocator}.
         */
        JdkZlibDecompressor(byte[] dictionary, int maxAllocation) {
         ...
         * supported atm.
         */
        JdkZlibDecompressor(ZlibWrapper wrapper) {
         ...
         *          If zero, maximum size is decided by the {@link ByteBufAllocator}.
         */
        JdkZlibDecompressor(ZlibWrapper wrapper, int maxAllocation) {
            this(wrapper, null, false, maxAllocation);
        }

        JdkZlibDecompressor(ZlibWrapper wrapper, boolean decompressConcatenated) {
            this(wrapper, null, decompressConcatenated, 0);
        }

        JdkZlibDecompressor(ZlibWrapper wrapper, boolean decompressConcatenated, int maxAllocation) {
            this(wrapper, null, decompressConcatenated, maxAllocation);
        }

        JdkZlibDecompressor(boolean decompressConcatenated) {
            this(ZlibWrapper.GZIP, null, decompressConcatenated, 0);
        }

        JdkZlibDecompressor(boolean decompressConcatenated, int maxAllocation) {
    ...
    private JdkZlibDecoder(ZlibWrapper wrapper, byte[] dictionary, boolean decompressConcatenated, int maxAllocation) {
        super(() -> new JdkZlibDecompressor(wrapper, dictionary, decompressConcatenated, maxAllocation));
    }
